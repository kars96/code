...
void input()
{
 ...
 for(i=0;i<tp;i++) { for(j=0;j<tr;j++) scanf("%d",&p[i]._maxneed[j]); }

  printf("\nEnter the allocation matrix\n");
  for(i=0;i<tp;i++) { for(j=0;j<tr;j++) scanf("%d",&p[i]._alloc[j]); }
 ...
 void print()
 {
  ...
  printf("\n_allocation matrix\n");
  for(i=0;i<tp;i++) { printf("p%-4d",i); for(j=0;j<tr;j++) printf("%4d",p[i]._alloc[j]); printf("\n");}

  printf("\nMax needs matrix\n");
  for(i=0;i<tp;i++) { printf("p%-4d",i); for(j=0;j<tr;j++) printf("%4d",p[i]._maxneed[j]); printf("\n");};

  printf("\nNeeds matrix\n");
  for(i=0;i<tp;i++) { printf("p%-4d",i); for(j=0;j<tr;j++) printf("%4d",p[i]._need[j]); printf("\n");};
}
...
void req()
{
 ...
 if(!lteq(temp,p[pid]._maxneed,tr))

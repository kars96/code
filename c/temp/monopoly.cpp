#define TH_COLOR RGB(255,255,184)
#define TH_IMG "bg4.tiff"
/*
#ifdef _WIN32
#include <windows.h>
#endif
...
glLightfv(GL_LIGHT0,GL_DIFFUSE,lightint);
	...
	glPushMatrix();
	 glRotatef(80,0,0,01);
	 glRotatef(180,1,0,0);
	 glTranslatef(0,0,-60);glutSolidCone(20,70,40,40);
	glPopMatrix();glPushMatrix();
	glScalef(1.9,1.9,.2);
	glutSolidCube(10);
	glPopMatrix();
...
ccode[(int)':']=COLON;
	...
	glShadeModel(GL_SMOOTH);f=fopen("LB.txt","r");
